![图片描述了“花时间 vs 花钱 · Cost vs Efficiency”的对比。人工实现重构模块需3 - 5天，编写测试用例1 - 2天，代码Review 2 - 4h，文档维护成本$2400/周，优势为质量可控、深度思考，但慢、耗时、易疲劳；Agent实现仅15分钟，30秒自动，优势为快、24h工作、可复制，但需Review、Token成本。核心公式为人类时间×时时薪 > Token成本 → 果断用Agent，强调50x速度提升vs 2%的成本。](assets/diagrams/zh_15_1.svg)
...
![图片对比对“花时间”和“花钱”两种方案在成本与效率上的差异。人工实现方面，重构模块需3 - 5天，编写测试用例1 - 2天，代码Reviewiew](assets/diagrams/zh_15_2.svg)