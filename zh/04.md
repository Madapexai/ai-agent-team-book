![图片是“选定你的第一个Agent”界面，核心内容是推荐从编码Agent开始，最快看到成效，2周内就能感受到产能提升。界面中以蓝色框突出显示“](assets/diagrams/zh_04_1.svg)
...
![图片为《给AI当老板》中“选定你的第一个Agent”章节的思维导图。上方标题为“选定你的第一个Agent”，中间核心问题是“你要Agent帮你做什么？”。下方有三个分支，分别是 addCriterion图片中](assets/diagrams/zh_04_2.svg)