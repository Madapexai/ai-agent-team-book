![图片展示了“监察员制度 - Supervisor Agent”的相关内容。左侧有四个方块，分别显示“Coding A.”“Review A.”““Testing A.”“Docs A.”的状态，其中“Testing A.”为“超时 - 启超时”，“Docs序号标识步骤的内容。这些内容属于核心内容，需要在描述图片](assets/diagrams/zh_10_1.svg)
...
![图片展示了“监察员制度 - Supervisor Agent”的相关内容。左侧有四个Agent状态框，分别是Coding A、Review A、Testing A、Docs A，其中Coding A和Review A状态正常，Testing A和Docs A状态异常。右侧是Supervisor Agent，每15分钟轮询所有Agent状态，检查进度、发现异常、自动干预。底部有升级路径、超时告警、Sup](assets/diagrams/zh_10_2.svg)