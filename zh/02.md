![图片图片描述专家图片展示了Agent的能力边界，分为Agent擅长的、人类擅长的、Agent不擅长的三部分。Agent擅长的包括代码、文档、测试、重复、搜索等任务；人类擅长的涵盖决策、创造、沟通、判断、分析等；Agent不擅长的有幻觉、长程、创造、伦理、审美等。该图与上下文紧密相关，直观呈现了Agent在不同任务上的能力差异，帮助理解其在](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=MTZjZTQ5NTU2Njc3OTY4MmMwOTYzM2RhMGY5MjU4NDNfNGUwODkyMGI0NmFlMjU3YjEwYzI0YmI0N2MwZTc3YzJfSUQ6NzY1MTgwMDAyMTAzMDgzMzExMF8xNzgzODcwMzkwOjE3ODM4NzM5OTBfVjM)
