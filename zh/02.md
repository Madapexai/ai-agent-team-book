![图片展示了 Agent 的能力边界，分为三部分：Agent 擅长的、人类擅长的、Agent 不擅长的。Agent 擅长代码、文档、测试、重复任务、搜索等；人类擅长决策、创造、沟通、判断、分析等；Agent 不擅长幻觉、长程任务、创造、伦理、审美等。该图直观呈现了 Agent 在不同任务上的能力差异。](assets/diagrams/zh_02_1.svg)
