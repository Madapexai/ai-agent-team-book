![Image showing the Inspector System — Supervisor Agent. On the left are four status blocks labeled 'Coding A.', 'Review A.', 'Testing A.', and 'Docs A.', where 'Testing A.' shows a timeout status. These are core elements of the system depicted in the image.](assets/diagrams/en_10_1.svg)
