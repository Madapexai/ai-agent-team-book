...
![Image showing the Sub-Agent architecture, with "Supervisor Agent" at the core, surrounded by multiple Sub-Agents such as "Review Agent" and "Testing Agent." Each Sub-Agent is labeled with its count below it, such as "](assets/diagrams/en_18_2.svg)
