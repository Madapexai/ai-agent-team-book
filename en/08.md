...
![Diagram showing the hybrid communication system, divided from left to right into CLI mode (structured), NL mode (natural language), and hybrid mode. CLI mode fits routine Agent interactions, status sync, task assignment, etc.](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZWVjYWExMTNmYmFhNzM1ZWVhMjJiMDJlZGM3YzMxOTVfMTY3YTM3OGIzMDlmYTc5NWJiYjcyNjljZjY1N2E1NDdfSUQ6NzY1MTgwMDA3MTY4ODI2MDU3Ml8xNzgzODcwNDk1OjE3ODM4NzQwOTVfVjM)
