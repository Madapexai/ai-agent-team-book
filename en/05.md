![Diagram of "Writing personas for Agents · System Prompt anatomy" — shows the building blocks of a System Prompt: role, context, goals, constraints, style, output, workflow, etc. For example, the role is a senior frontend architect, the context is a project using a Monorepo architecture, and the goal is to implement features with minimal code changes. It also lists things not to do and code style.](assets/diagrams/en_05_1.svg)
...
![Diagram of "Writing personas for Agents · System Prompt anatomy" — shows the structure of a System Prompt, broken down into role, context, goals, constraints, style, ...](assets/diagrams/en_05_2.svg)
