![Diagram of "Writing personas for Agents · System Prompt anatomy" — shows the building blocks of a System Prompt: role, context, goals, constraints, style, output, workflow, etc. For example, the role is a senior frontend architect, the context is a project using a Monorepo architecture, and the goal is to implement features with minimal code changes. It also lists things not to do and code style.](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=YWRjZTgwMGFjY2I0ZDA0YTFhNmVlNzFjOGRjOTIyNzJfYjQ0MWQ4ZDJiNGNiZTE4NGNhZjNjZTU2MDRhZjVhYzRfSUQ6NzY1MTgwMDA0NTMwNjE4NjY4OF8xNzgzODcwNDkzOjE3ODM4NzQwOTNfVjM)
...
![Diagram of "Writing personas for Agents · System Prompt anatomy" — shows the structure of a System Prompt, broken down into role, context, goals, constraints, style, ...](https://internal-api-drive-stream.feishu.cn/space/api/box/stream/download/authcode/?code=ZjcxMWJlYWNiMWQ2NGIwNmViNTZkOWNmNjhiMGIxNGJfMGFkYWZhNTJlN2YxY2QyZDkxNTE1M2ZiYmZmYTg1MDdfSUQ6NzY1MTgwMDA0NTQ4NzAxNjkzOV8xNzgzODcwNDkzOjE3ODM4NzQwOTNfVjM)
