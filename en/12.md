...
![Image showing the four stages of the Agent self-evolution mechanism. Stage 1 is Observation — recording success/failure patterns and auditing token consumption while executing tasks. Stage 2 is Analysis — identifying successful patterns and discovering improvement opportunities. Stage 3 is Improvement. Stage 4 is Verification, with A/B test validation.](assets/diagrams/en_12_2.svg)
