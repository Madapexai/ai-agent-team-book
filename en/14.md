...
![Image shows the Review mechanism](assets/diagrams/en_14_1.svg)
...
![Image shows the Review mechanism and feedback loops. It's divided into five stages — auto checks, AI review, human review, integration verification, and launch/release — each with corresponding content. It's also split into fast feedback (real-time), medium-speed feedback (hour-level), and slow feedback](assets/diagrams/en_14_2.svg)
